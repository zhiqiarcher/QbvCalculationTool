...
def Calculate():
    ...
    SystemDescription = Script.get("0.0","end")
...
def AddPort():
    Content = PortScript.get("0.0","end").split("\n")[0]
    PortPara = Content.split(",")
    SplitResult = Script.get("0.0","end").split("\n")
    ...
    Script.insert("insert",rebuild)

def AddStream():
    Content = StreamScript.get("0.0","end").split("\n")[0]
...
def UpdateMeta():
    ...
    AmtofQbvCls = AmountofQbvClasstxt.get("0.0","end").split("\n")[0]
    GuardBandSizeinBits = GuardBandSizeinBitstxt.get("0.0","end").split("\n")[0]
    MiniNoQbvSlotSizeinBits = MiniNoQbvSlotSizeinBitstxt.get("0.0","end").split("\n")[0]
